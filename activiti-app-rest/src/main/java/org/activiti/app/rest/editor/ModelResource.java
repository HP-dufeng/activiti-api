...
public class ModelResource extends AbstractModelResource {
   ...
   */
  @ApiOperation(value = "Get model", response = ModelRepresentation.class)
  @RequestMapping(value = "/rest/models/{modelId}", method = RequestMethod.GET, produces = "application/json")
  public ModelRepresentation getModel(@PathVariable("modelId") String modelId) {
   ...
   */
  @ApiOperation(value = "Get model thumbnail", response = byte[].class)
  @RequestMapping(value = "/rest/models/{modelId}/thumbnail", method = RequestMethod.GET, produces = MediaType.IMAGE_PNG_VALUE)
  public byte[] getModelThumbnail(@PathVariable("modelId") String modelId) {
   ...
   */
  @ApiOperation(value = "Update model", response = ModelRepresentation.class)
  @ApiResponses(value = {
          @ApiResponse(code = 400, message = "Model with provided key already exists.")
  })
  @RequestMapping(value = "/rest/models/{modelId}", method = RequestMethod.PUT)
  public ModelRepresentation updateModel(@PathVariable("modelId") String modelId, @RequestBody ModelRepresentation updatedModel) {
   ...
   */
  @ApiOperation(value = "Delete model", response = Void.class)
  @ResponseStatus(value = HttpStatus.OK)
  @RequestMapping(value = "/rest/models/{modelId}", method = RequestMethod.DELETE)
  public void deleteModel(@PathVariable("modelId") String modelId, @RequestParam(required = false,value = "cascade") Boolean cascade, @RequestParam(required = false,value = "deleteRuntimeApp") Boolean deleteRuntimeApp) {
   ...
   */
  @ApiOperation(value = "Get the JSON model")
   ...
   */
  @ApiOperation(value = "Save the JSON model", response = ModelRepresentation.class)
  @ApiResponses(value = {
          @ApiResponse(code = 400, message = "Invalid lastUpdated date.")
  })
   ...
   */
  @ApiOperation(value = "Create a new model version", response = ModelRepresentation.class)
  @RequestMapping(value = "/rest/models/{modelId}/newversion", method = RequestMethod.POST)
  public ModelRepresentation importNewVersion(@PathVariable("modelId") String modelId, @RequestPart("file") MultipartFile file) {
