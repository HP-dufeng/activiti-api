 ...
 */
@Api(tags = { "runtime - appDefinition" }, description = "App definition resource", authorizations = { @Authorization(value = "basicAuth") })
@RestController
public class AppDefinitionsResource extends AbstractAppDefinitionsResource {
  ...
  @ApiOperation(value = "Get app definition list", response = AppDefinitionRepresentation.class,responseContainer = "List")
  ...
  @ApiOperation(value = "Get app definition", response = AppDefinitionRepresentation.class)
