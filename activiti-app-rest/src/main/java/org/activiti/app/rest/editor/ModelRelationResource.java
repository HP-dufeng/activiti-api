...
public class ModelRelationResource extends AbstractModelResource {
  ...
  @ApiOperation(value = "Get model relations", response = ModelInformation.class, responseContainer = "List")
  @RequestMapping(value = "/rest/models/{modelId}/parent-relations", method = RequestMethod.GET, produces = "application/json")
  public List<ModelInformation> getModelRelations(@PathVariable("modelId") String modelId) {
