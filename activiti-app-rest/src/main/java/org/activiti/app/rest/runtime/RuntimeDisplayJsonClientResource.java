...
@RestController
@Api(tags = { "runtime - runtimeDisplayJsonClient" }, description = "Runtime display json client resource", authorizations = { @Authorization(value = "basicAuth") })
public class RuntimeDisplayJsonClientResource {
  ...
  @ApiOperation(value = "Get model json", response = JsonNode.class)
  ...
  public JsonNode getModelJSON(@PathVariable("processInstanceId") String processInstanceId) {
  ...
  @ApiOperation(value = "Get model json for process definition", response = JsonNode.class)
  ...
  public JsonNode getModelJSONForProcessDefinition(@PathVariable("processDefinitionId") String processDefinitionId) {
  ...
  @ApiOperation(value = "Get model history json ", response = JsonNode.class)
  ...
  public JsonNode getModelHistoryJSON(@PathVariable("processInstanceId") String processInstanceId) {
