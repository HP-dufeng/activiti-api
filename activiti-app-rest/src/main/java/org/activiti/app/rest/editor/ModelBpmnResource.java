 ...
 */
@RestController
@Api(tags = { "editor - model" }, description = "Process Manage", authorizations = { @Authorization(value = "basicAuth") })
public class ModelBpmnResource extends AbstractModelBpmnResource {

  /**
   * GET /rest/models/{modelId}/bpmn -> Get BPMN 2.0 xml
   */
  @ApiOperation(value = "Get BPMN 2.0 xml")
  @RequestMapping(value = "/rest/models/{processModelId}/bpmn20", method = RequestMethod.GET)
  public void getProcessModelBpmn20Xml(HttpServletResponse response, @PathVariable("processModelId") String processModelId) throws IOException {
   ...
   */
  @ApiOperation(value = "Get BPMN 2.0 xml for process definition history")
  @RequestMapping(value = "/rest/models/{processModelId}/history/{processModelHistoryId}/bpmn20", method = RequestMethod.GET)
  public void getHistoricProcessModelBpmn20Xml(HttpServletResponse response, @PathVariable("processModelId") String processModelId, @PathVariable("processModelHistoryId") String processModelHistoryId) throws IOException {
