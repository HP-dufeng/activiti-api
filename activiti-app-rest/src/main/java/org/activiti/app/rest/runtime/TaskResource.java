...
public class TaskResource extends AbstractTaskResource {
    ...
    @ApiOperation(value = "Get task", response = TaskRepresentation.class)
    @RequestMapping(value = "/rest/tasks/{taskId}",
            method = RequestMethod.GET,
            produces = "application/json")
    public TaskRepresentation getTask(@PathVariable("taskId") String taskId, HttpServletResponse response) {
    	return super.getTask(taskId, response);
    }

    @ApiOperation(value = "Update task", response = TaskRepresentation.class)
    @RequestMapping(value = "/rest/tasks/{taskId}",
