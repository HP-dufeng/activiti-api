...
@Api(tags = { "idm - idmProfile" }, description = "Manage idm profile", authorizations = { @Authorization(value = "basicAuth") })
public class IdmProfileResource {
  
  @Autowired
  protected IdentityService identityService;

  @ApiOperation(value = "Get a user profile", response = UserRepresentation.class)
  ...
  @ApiOperation(value = "Update user profile", response = UserRepresentation.class)
  @ApiResponses(value = {
          @ApiResponse(code = 400, message = "Empty email is not allowed")
  })
  ...
  @ApiResponses(value = {
          @ApiResponse(code = 404, message = "Indicate the user not found.")
  })
  ...
  @ApiResponses(value = {
          @ApiResponse(code = 500, message = "Could not get profile picture")
  })
  ...
  @ApiOperation(value = "Update user picture")
  @ApiResponses(value = {
          @ApiResponse(code = 200, message = "Indicate the picture upload successed.")
  })
  @ResponseStatus(value = HttpStatus.OK)
