 ...
 */
@RestController
@Api(tags = { "editor - editorGroups" }, description = "Process Manage", authorizations = { @Authorization(value = "basicAuth") })
public class EditorGroupsResource {

  @Autowired
  protected IdentityService identityService;

  @ApiOperation(value = "Get groups", response = Group.class, responseContainer = "List")
