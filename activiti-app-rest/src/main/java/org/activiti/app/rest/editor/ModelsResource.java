...
public class ModelsResource extends AbstractModelsResource {
  ...
  @ApiOperation(value = "Query models", response = ModelRepresentation.class, responseContainer = "List")
  @RequestMapping(value = "/rest/models", method = RequestMethod.GET, produces = "application/json")
  public ResultListDataRepresentation getModels(@RequestParam(required = false,value = "filter") String filter, @RequestParam(required = false,value = "sort") String sort, @RequestParam(required = false,value = "modelType") Integer modelType,
      HttpServletRequest request) {

    return super.getModels(filter, sort, modelType, request);
  }

  @ApiOperation(value = "Get models to include in app definition", response = ModelRepresentation.class, responseContainer = "List")
  ...
  @ApiOperation(value = "Import process model", response = ModelRepresentation.class)
  @RequestMapping(value = "/rest/import-process-model", method = RequestMethod.POST, produces = "application/json")
  public ModelRepresentation importProcessModel(HttpServletRequest request, @RequestPart("file") MultipartFile file) {
   ...
   */
  @ApiOperation(value = "Import process model text", response = String.class)
  @RequestMapping(value = "/rest/import-process-model/text", method = RequestMethod.POST)
  public String importProcessModelText(HttpServletRequest request, @RequestPart("file") MultipartFile file) {
  ...
  @ApiOperation(value = "Create model", response = ModelRepresentation.class)
  ...
  @ApiOperation(value = "Duplicate model", response = ModelRepresentation.class)
  @RequestMapping(value = "/rest/models/{modelId}/clone", method = RequestMethod.POST, produces = "application/json")
  public ModelRepresentation duplicateModel(@PathVariable("modelId") String modelId, @RequestBody ModelRepresentation modelRepresentation) {
