...
@RestController
@Api(tags = { "editor - stencilSet" }, description = "Process Manage", authorizations = { @Authorization(value = "basicAuth") })
public class StencilSetResource {
  ...
  @ApiOperation(value = "Get bpmn node json stencil definitions")
