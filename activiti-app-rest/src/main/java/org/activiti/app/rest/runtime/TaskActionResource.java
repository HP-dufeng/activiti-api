...
public class TaskActionResource {
  ...
  @ApiOperation(value = "Assign task", response=TaskRepresentation.class)
  @RequestMapping(value = "/rest/tasks/{taskId}/action/assign", method = RequestMethod.PUT)
  public TaskRepresentation assignTask(@PathVariable("taskId") String taskId, @RequestBody ObjectNode requestNode) {
    return taskActionService.assignTask(taskId, requestNode);
  }

  @ApiOperation(value = "Involve user")
  ...
  @ApiOperation(value = "Remove involved user")
